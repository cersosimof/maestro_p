...
<table 	class=" table text-center">
            ...
            ?>      <tr onclick="abrirExpediente(<?php echo $expedientes["nroExpediente"]; ?>)" id="<?php echo $expedientes["idListado"]; ?>" class="resaltar">
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
 ...
 function abrirExpediente(exp) {
     var nroExpediente = exp;

		$.ajax({
			type: 'POST',
			url: '../AJAX/mostrarListado.php',
			data: { 'exp': nroExpediente },
			success: function(data){
				document.querySelector("#prueba").innerHTML = data;
                $("#momodal").modal("show")
			}
		})
